    ...
    <div class="bg-white p-6 m-3 space-y-10 shadow-2xl rounded-3xl md:p-40">
      ...
      <div class="grid gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
        ...
        <div class="relative group">
          <img src="gallery/image1.jpg" alt="" class="w-72" />
          <div
          ...
          >
            <div class="flex justify-between w-full">
              ...
              <div class="flex items-center">
                <img src="gallery/bookmark.svg" alt="bookmark" />
              </div>
            </div>
          </div>
        </div>
        ...
        <!-- Image 2 -->
        <div class="relative group">
          <img src="gallery/image2.jpg" alt="" class="w-72" />
          <div
            class="absolute bottom-0 left-0 right-0 p-2 px-4 text-white duration-500 bg-black opacity-0 group-hover:opacity-100 bg-opacity-40"
          >
            <div class="flex justify-between w-full">
        ...
        <!-- Image 3 -->
        <div class="relative group">
          <img src="gallery/image3.jpg" alt="" class="w-72" />
          <div
            class="absolute bottom-0 left-0 right-0 p-2 px-4 text-white duration-500 bg-black opacity-0 group-hover:opacity-100 bg-opacity-40"
          >
            <div class="flex justify-between w-full">
        ...
        <!-- Image 4 -->
        <div class="relative group">
          <img src="gallery/image4.jpg" alt="" class="w-72" />
          <div
            class="absolute bottom-0 left-0 right-0 p-2 px-4 text-white duration-500 bg-black opacity-0 group-hover:opacity-100 bg-opacity-40"
          >
            <div class="flex justify-between w-full">
        ...
        <!-- Image 5 -->
        <div class="relative group">
          <img src="gallery/image5.jpg" alt="" class="w-72" />
          <div
            class="absolute bottom-0 left-0 right-0 p-2 px-4 text-white duration-500 bg-black opacity-0 group-hover:opacity-100 bg-opacity-40"
          >
            <div class="flex justify-between w-full">
        ...
        <!-- Image 6 -->
        <div class="relative group">
          <img src="gallery/image6.jpg" alt="" class="w-72" />
          <div
            class="absolute bottom-0 left-0 right-0 p-2 px-4 text-white duration-500 bg-black opacity-0 group-hover:opacity-100 bg-opacity-40"
          >
            <div class="flex justify-between w-full">
